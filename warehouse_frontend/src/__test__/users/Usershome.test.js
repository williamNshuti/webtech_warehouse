...
import OffersDataService from "../../api/warehouse/OffersDataService";
...
it("should return no theWarehouses", async () => {
  const theWarehouses = [];
  mockAxios.get.mockResolvedValueOnce(theWarehouses);
...
it("should render multiple theWarehouses", async () => {
  const theWarehouses = [
    {
